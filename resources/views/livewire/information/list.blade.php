<div class="min-w-full align-middle">
    <!-- Header with New Information button -->
    ...
    <div class="mb-4 flex flex-col sm:flex-row flex-wrap gap-4">
        ...
        <!-- Category Filter -->
        <div class="flex-1 w-full sm:min-w-[200px]">
            <x-input-label for="filterCategoryId" value="Filter by Category" />
            <select 
                id="filterCategoryId"
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <div class="flex items-center justify-end gap-2" x-data="{ open: false }" @click.stop>
                            ...
                            <div 
                                ...
                                <div class="py-1">
                                    <button 
                                        wire:click="$dispatch('openModal', { component: 'modals.information-modal', arguments: { information: {{ $information }} }})"
                                        class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        Edit
                                    </button>
                                    <button 
                                        onclick="copyToClipboard('{{ route('information.public', $information->id) }}')"
                                        class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        Copy Link
                                    </button>
                                </div>
    ...
    <div class="md:hidden space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-4 relative">
                <div class="flex items-start justify-between gap-3">
                    <div class="flex-1 min-w-0 cursor-pointer" wire:click="$dispatch('openModal', { component: 'modals.show.information-modal', arguments: { information: {{ $information }} }})">
                        ...
                        <div class="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                            <span>{{ $information->created_at->format('M d, Y') }}</span>
                            @if($information->category)
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 text-center">
            <p class="text-sm text-gray-500 dark:text-gray-400">No information available.</p>
        </div>
        @endforelse
    </div>
