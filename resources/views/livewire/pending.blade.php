<div class="min-w-full align-middle overflow-auto max-w-4xl mx-auto pt-10 pr-4 pl-4 sm:pr-10 sm:pl-10"
    wire:poll.120000ms>
                ...
                <table class="min-w-full border divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left bg-gray-50 sm:px-6 sm:py-3">
                                <span
                                    class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">Type</span>
                            </th>
                            <th class="px-4 py-3 text-left bg-gray-50 sm:px-6 sm:py-3">
                                <span
                                    class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">Date</span>
                            </th>
                        </tr>
                    </thead>
