    ...
    <div class="grid grid-cols-2 gap-2">
        <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
            ...
            @empty
                ...
                >
                    <div class="pt-3 sm:pt-5">
                        <h2 class="text-xl font-semibold text-black dark:text-white">No complaints found</h2>
                    </div>
                </a>
            @endforelse
        </div>
        <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
            ...
            @empty
                ...
                >
                    <div class="pt-3 sm:pt-5">
                        <h2 class="text-xl font-semibold text-black dark:text-white">No Announcemnets found</h2>
                    </div>
                </a>
            @endforelse
