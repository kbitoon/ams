<div class="p-6">
        <form wire:submit.prevent="save">
            ...
            <div class="mt-4">
                ...
                <select wire:model.live.debounce.500ms="form.vehicle_id" id="vehicle_id" class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div class="mt-4">
                ...
                <select wire:model.live.debounce.500ms="form.driver_id" id="driver_id" class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
