<div class="p-6">
    ...
    <form wire:submit="save">
        ...
        <div>
            ...
            <textarea wire:model="form.narration" id="narration" class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" type="text"></textarea>
