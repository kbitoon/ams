<div class="p-6">
        <form wire:submit.prevent="save">
            ...
            <div class="mt-4">
                ...
                <select wire:model.live.debounce.250ms="form.item_id" id="item_id" class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
