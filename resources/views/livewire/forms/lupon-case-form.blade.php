<div class="p-6">
    ...
    <form wire:submit="save">
        ...
        <div class="mt-4">
            ...
            <input type="file" wire:model.defer="form.resolution_forms" id="resolution_forms" multiple
            ...
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Select one or more files (PDF, Word, images).</p>
