...
<div class="dashboard-container" wire:poll.30s>
        ...
        <div class="mb-4">
            <h1 class="text-2xl font-bold mb-3 text-center" style="color: #60a5fa;">
                <i class="fas fa-tv mr-2"></i>Monitoring Dashboard
            </h1>
        ...
        <div class="card clearance-card mb-4">
                    ...
                    @foreach($pendingClearances as $clearance)
                        <div class="item-row">
                            <div class="flex justify-between items-start mb-2">
                                <div>
                                    <div class="font-semibold text-base mb-1">{{ $clearance->name }}</div>
        ...
        <div class="grid-2">
            ...
            <div class="card">
                ...
                @if($pendingLuponCases->count() > 0)
                    @foreach($pendingLuponCases as $case)
                        <div class="item-row">
        ...
        <div class="grid-2 mt-4">
            <div class="card">
                ...
                @if($recentComplaintComments->count() > 0)
                    @foreach($recentComplaintComments as $comment)
                        <div class="item-row">
            ...
            <div class="card">
                ...
                @if($recentLuponComments->count() > 0)
                    @foreach($recentLuponComments as $comment)
                        <div class="item-row">
        ...
        <div class="grid-2 mt-4">
            ...
            <div class="card">
                ...
                @if($latestBlotters->count() > 0)
                    @foreach($latestBlotters as $blotter)
                        <div class="item-row">
        ...
        <div class="grid-2 mt-4">
            <div class="card">
                ...
                @if($todayFacilitySchedules->count() > 0)
                    @foreach($todayFacilitySchedules as $schedule)
                        <div class="item-row">
            ...
            <div class="card">
                ...
                @if($todayVehicleSchedules->count() > 0)
                    @foreach($todayVehicleSchedules as $schedule)
                        <div class="item-row">
